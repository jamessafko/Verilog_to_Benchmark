...
public class OAI222X1 extends Gate{
	...
	public void addOAI222X1(List<String> signals, HashMap<String, Gate> hm){				
		/* OA222X1 (IN1,IN2,IN3,IN4,IN5,IN6,Q);
		 * OR (IN2,IN1, g_1_out,);
		 * OR (IN4,IN3, g_2_out,);
		 * OR (IN6,IN5, g_3_out,);
		 * NAND #1 (g_1_out,g_2_out,g_3_out, Q);
		 */
		...
		//NAND GATE
		super.addNand(intermediateOne, intermediateTwo, intermediateThree, signals.get(6), hm);
