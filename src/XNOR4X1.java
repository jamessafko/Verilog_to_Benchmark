...
public class XNOR4X1 extends Gate{
	...
	public void addXNOR4X1(List<String> signals, HashMap<String, Gate> hm){				
		...
		//AND GATE
		String intermediateOne = "XNOR4X1_" + intermediateCount++ + "_out";
		super.addAnd(notA, signals.get(1), intermediateOne, hm);
		
		//AND GATE
		String intermediateTwo = "XNOR4X1_" + intermediateCount++ + "_out";
		super.addAnd(signals.get(0), notB, intermediateTwo, hm);
		
		//OR GATE
		String out1 = "XNOR4X1_" + intermediateCount++ + "_out";
		...
		//AND GATE
		String intermediateThree = "XNOR4X1_" + intermediateCount++ + "_out";
		super.addAnd(out1, notC, intermediateThree, hm);
		
		//AND GATE
		String intermediateFour = "XNOR4X1_" + intermediateCount++ + "_out";
		super.addAnd(notOut1, signals.get(2), intermediateFour, hm);
		
		//OR GATE
		String out2 = "XNOR4X1_" + intermediateCount++ + "_out";
		...
		//AND GATE
		String intermediateFive = "XNOR4X1_" + intermediateCount++ + "_out";
		super.addAnd(out2, notD, intermediateFive, hm);
		
		//AND GATE
		String intermediateSix = "XNOR4X1_" + intermediateCount++ + "_out";
		super.addAnd(notOut2, signals.get(2), intermediateSix, hm);
		
		//OR GATE
		String notOut = "not_" + signals.get(4);
		super.addOr(intermediateFive, intermediateSix, notOut, hm);
		
		//Not gate
		super.addNot(notOut, signals.get(4), hm);
	}
